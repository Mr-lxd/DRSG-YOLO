...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', type=str, default="runs/detect/DRSGYOLO_dataREmake_ours_add_pub1&2/weights/DRSG-YOLO.pt", help='Model weights path')
    parser.add_argument('--data-dir', type=str, default="D:/dataset_split_pick/test/images", help='Test images directory')
